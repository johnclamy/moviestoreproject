...
movies = [
    {
        'id': 1, 'name': 'Bitcoin Heist', 'price': 11.99,
    ...
    {
        'id': 4, 'name': 'Fountain of Youth', 'price': 14.99,
    ...
    {
        'id': 8, 'name': 'Black Bag', 'price': 11.99,
    ...
    {
        'id': 9, 'name': 'Mission: Impossible - Dead Reckoning Part One', 'price': 14.99,
    ...
    {
        'id': 10, 'name': 'Warfare', 'price': 14.99,
    ...
    {
        'id': 11, 'name': 'Companion', 'price': 11.99,
    ...
    {
        'id': 12, 'name': 'The Phoenician Scheme', 'price': 11.99,
